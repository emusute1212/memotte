...
public abstract class Hilt_MemoListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MemoListFragment() {
    super();
  }

  Hilt_MemoListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MemoListFragment_GeneratedInjector) this.generatedComponent()).injectMemoListFragment(UnsafeCasts.<MemoListFragment>unsafeCast(this));
    }
  }
